...
export function ProjectsSection() {
  ...
  return (
    <section
      id='projects'
      className='container mx-auto px-4 w-full bg-background py-8'
    >
      {loading ? (
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
          ...
          <Card className='flex flex-col overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl bg-card text-card-foreground'>
            <CardHeader className='flex-grow justify-between'>
              <CardTitle className='font-headline text-xl text-secondary-foreground'>
                {t.projects_explore_title}
              </CardTitle>
